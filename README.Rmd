...
Note that some of the functions may take some time to run -- it can be doing operations across hundreds of thousands of rows (all majors by all degrees by all years by all institutions makes for a lot of data).
